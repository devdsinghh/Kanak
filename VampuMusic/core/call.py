...
from VampuMusic import LOGGER, YouTube, app
from VampuMusic.misc import db
...
from VampuMusic.utils.exceptions import AssistantErr
from VampuMusic.utils.formatters import check_duration, seconds_to_min, speed_converter
from VampuMusic.utils.inline.play import stream_markup
from VampuMusic.utils.thumbnails import get_thumb
...
class Call(PyTgCalls):
    def __init__(self):
        self.userbot1 = Client(name="VampuAss1", api_id=config.API_ID, api_hash=config.API_HASH, session_string=str(config.STRING1))
        self.one = PyTgCalls(self.userbot1, cache_duration=100)
        self.userbot2 = Client(name="VampuAss2", api_id=config.API_ID, api_hash=config.API_HASH, session_string=str(config.STRING2))
        self.two = PyTgCalls(self.userbot2, cache_duration=100)
        self.userbot3 = Client(name="VampuAss3", api_id=config.API_ID, api_hash=config.API_HASH, session_string=str(config.STRING3))
        self.three = PyTgCalls(self.userbot3, cache_duration=100)
        self.userbot4 = Client(name="VampuAss4", api_id=config.API_ID, api_hash=config.API_HASH, session_string=str(config.STRING4))
        self.four = PyTgCalls(self.userbot4, cache_duration=100)
        self.userbot5 = Client(name="VampuAss5", api_id=config.API_ID, api_hash=config.API_HASH, session_string=str(config.STRING5))
