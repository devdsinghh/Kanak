...
# -----------------------------------------------
# 🔸 KRITIMusic Project
# 🔹 Developed & Maintained by: Shashank Shukla (https://github.com/Badnam019)
...
#
# ❤️ Made with dedication and love by lll_BADNAM_BABY_llll
# -----------------------------------------------
...
def welcomepic(pic, user, chatname, id, uname, brightness_factor=1.3):
    background = Image.open("VampuMusic/assets/wel2.png")
    pfp = Image.open(pic).convert("RGBA")
    pfp = circle(pfp, brightness_factor=brightness_factor)
    pfp = pfp.resize((535, 535))
    draw = ImageDraw.Draw(background)
    font = ImageFont.truetype('VampuMusic/assets/font.ttf', size=60)
