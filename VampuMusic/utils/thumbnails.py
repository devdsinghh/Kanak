...
async def get_thumb(videoid: str, player_username: str = None) -> str:
    ...
    try:
        title_font = ImageFont.truetype("VampuMusic/assets/font.ttf", 44)
        meta_font = ImageFont.truetype("VampuMusic/assets/font.ttf", 26)
        tag_font = ImageFont.truetype("VampuMusic/assets/font2.ttf", 28)
    except:
